...
<?php
	...
	{
		$path1 = "../../../artist_users/Other/".$user."/achievement/";
		$path2 = "../../../artist_users/Other/".$user."/final_image/";
		$path3 = "../../../artist_users/Other/".$user."/image/";
		$path4 = "../../../artist_users/Other/".$user."/profile/";
		$path5 = "../../../artist_users/Other/".$user."/Post/";
		$path6 = "../../../artist_users/Other/".$user."/resume/";
		$path7 = "../../../artist_users/Other/".$user."/thumbnails/";
    	...
    	move_uploaded_file($img_tmp_name,"../../../artist_users/Other/".$user."/profile/".$prod_img_path);
