...
<?php
	...
	{
		$path1 = "../../../artist_users/Female/".$user."/achievement/";
		$path2 = "../../../artist_users/Female/".$user."/final_image/";
		$path3 = "../../../artist_users/Female/".$user."/image/";
		$path4 = "../../../artist_users/Female/".$user."/profile/";
		$path5 = "../../../artist_users/Female/".$user."/Post/";
		$path6 = "../../../artist_users/Female/".$user."/resume/";
		$path7 = "../../../artist_users/Female/".$user."/thumbnails/";
    	...
    	move_uploaded_file($img_tmp_name,"../../../artist_users/Female/".$user."/profile/".$prod_img_path);
